...
void loop() {
  ...
  if (data == '1' || data == '2' || data == '3' || data == '4' || data == '5') {
    ...
    if (new_function_request == false) {
      receiver_input_channel_3 = convert_receiver_channel(3);
      if (data == '1' || data == '5') esc_1 = receiver_input_channel_3; else esc_1 = 1000;
      if (data == '2' || data == '5') esc_2 = receiver_input_channel_3; else esc_2 = 1000;
      if (data == '3' || data == '5') esc_3 = receiver_input_channel_3; else esc_3 = 1000;
      if (data == '4' || data == '5') esc_4 = receiver_input_channel_3; else esc_4 = 1000;
      esc_pulse_output();
      if (eeprom_data[31] == 1) {
